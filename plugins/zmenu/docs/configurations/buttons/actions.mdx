...
<Tabs>
    ...
    <TabItem value="actionbar" label="actionbar (Alias)">
...
:::warning Requires PacketEvents
This action is only available when the [PacketEvents](https://github.com/retrooper/packetevents) plugin is installed on your server. Without it, the action is simply not registered and will silently do nothing.
:::
...
See [Bedrock Forms](../bedrock) for complete Bedrock form configuration documentation.
...
<Tabs>
    <TabItem value="permission-set" label="permission-set">
...
<Tabs>
    <TabItem value="set_item" label="set_item">
    ...
    <TabItem value="set-item" label="set-item (Alias)">
...
<Tabs>
    <TabItem value="take_item" label="take_item">
    ...
    <TabItem value="take-item" label="take-item (Alias)">
...
<Tabs>
    <TabItem value="refresh_slot" label="refresh_slot">
    ...
    <TabItem value="refresh-slot" label="refresh-slot (Alias)">
