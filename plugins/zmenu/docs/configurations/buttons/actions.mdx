...
<Tabs>
    ...
    <TabItem value="player command" label="player command (Alias)">
        ...
        Available aliases: `player-command`, `player_command`, `player_commands`, `player command`, `player commands`, `player-command` and `player-commands`.
        Command in chat aliases: `command-in-chat` and `commandInChat`.
...
<Tabs>
    ...
    <TabItem value="player command as op" label="player command as op (Alias)">
        ...
        Available aliases: `player-command-as-op`, `player-command-as-op`, `player commands as op`, `player command as op`, `player_commands_as_op` and `player_command_as_op`.
