---
sidebar_position: 3
title: Admin Expired Items
description: Admin expired items inventory configuration
---
...
|--------|------|-------------|
| `items` | [`ZAUCTIONHOUSE_ADMIN_EXPIRED_ITEMS`](../buttons#admin-buttons) | Displays expired items with admin retrieval |
